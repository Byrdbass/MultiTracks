<%@ Page Language="C#" AutoEventWireup="true" CodeFile="list.aspx.cs" Inherits="api_song_list" %>
        ...
        <div class="wrapper mod-standard mod-gray">
            ...
            <nav class="discovery--nav">
                <ul class="discovery--nav--list tab-filter--list u-no-scrollbar">
                    ...
                    <li class="discovery--nav--list--item tab-filter--item">
                        <a class="tab-filter" href="../artist/search.aspx">Search Artist</a>
                    </li>
                    <li class="discovery--nav--list--item tab-filter--item is-active">
                        <a class="tab-filter" href="/">Songs By Page</a>
                    </li>
                    <li class="discovery--nav--list--item tab-filter--item">
                            ...
                            <li class="song-list--item media-player--row">
                                ...
                                <div class="song-list--item--player-img media-player">
                                    <img class="song-list--item--player-img--img"
                                        src="<%= AlbumImages[i] %>" alt="<%=AlbumTitles[i] %>">
                                </div>

                                <div class="song-list--item--right">

                                    <a href="#" class="song-list--item--primary"><%=SongTitles[i]%></a>
                                    <a class="song-list--item--secondary"><%=AlbumTitles[i]%></a>
                                    <a class="song-list--item--secondary"><%=BPMs[i] %> BPM</a>
                                    <a class="song-list--item--secondary"><%=TimeSignatures[i] %>/4</a>
